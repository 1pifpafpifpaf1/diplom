...
namespace kursovaya
{
    public partial class Склад2 : MetroFramework.Forms.MetroForm
    {
        public Склад2()
        {
            InitializeComponent();
        ...
        public void GetListEq()
        {
            ...
            string commandStr = "SELECT " +
                ...
                "eq_sklad.eq_count AS 'Количество' " +
                                    "FROM eq_sklad " +
                                    $"JOIN equipment ON equipment.id_equipment = eq_sklad.id_equipment WHERE eq_sklad.id_sklad != {Auth.auth_role}";
        ...
        private void Склад2_Load(object sender, EventArgs e)
        {
            GetListEq();
